...
//Number()-converte string em number (também é possível escrever console.log(+novoNumero * + novoNumeroString) para converter parar número
//String()-converte number em string (existe a forma .toString() para converter números para string se assemelhando à outras linguagens)
